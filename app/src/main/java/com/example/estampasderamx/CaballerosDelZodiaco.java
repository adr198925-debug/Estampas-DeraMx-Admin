...
import com.example.estampasderamxadmin.R;
import com.google.firebase.database.*;

import java.util.ArrayList;
import java.util.List;

public class CaballerosDelZodiaco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.caballerosdelzodiaco);

        titulo = findViewById(R.id.titulo_cbz);
        ...
        adapter = new AdapterEstampas(listaFiltrada, estampasDisponibles, 13, "");
        ...
        btnSiguiente.setOnClickListener(v -> {
            if (nivelActual == 0) {
                ...
                int totalFinalCBZ = conteoEstampas + estampasDisponibles.size();
                Intent intent = new Intent(this, Resumen_CaballerosDelZodiaco.class);
                intent.putExtra("PUNTOS_CBZ", totalFinalCBZ);
    ...
    private void cargarEstampas() {
        titulo.setText("Caballeros del Zodiaco");
        rutaActual = "CBZ/estampas";
        cargarDatos();
    }

    private void cargarEspeciales() {
        titulo.setText("Especiales");
        rutaActual = "CBZ/especiales";
        cargarDatos();
    }
    ...
    private void cargarDatos() {
        ...
        listener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // LLAMADA AUTOMÁTICA AL FILTRO: Para que la lista cargue de inmediato
