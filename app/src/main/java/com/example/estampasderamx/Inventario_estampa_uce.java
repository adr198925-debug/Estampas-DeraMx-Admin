...
public class Inventario_estampa_uce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventario_estampa_theult);
        ...
        refEst = FirebaseDatabase.getInstance().getReference("DBS_UCE/estampas");
        refEsp = FirebaseDatabase.getInstance().getReference("DBS_UCE/especiales");

        cargarNodo(refEst, "");
        cargarNodo(refEsp, "Esp");

        Button btnRegresar = findViewById(R.id.btnRegresar);
        Button btnFinalizar = findViewById(R.id.btnFinalizar);

        // Guardar también al regresar para asegurar que no se pierdan cambios
    ...
    private void guardarLocalmente() {
        SharedPreferences pref = getSharedPreferences("Stock_UCE", MODE_PRIVATE);
    ...
    // Guardar si el usuario usa el botón físico de atrás del celular
    @Override
