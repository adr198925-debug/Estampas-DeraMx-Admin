...
public class Inventario_estampa_cbz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventario_estampa_cbz);
        ...
        refE = FirebaseDatabase.getInstance().getReference("CBZ/estampas");
        refEsp = FirebaseDatabase.getInstance().getReference("CBZ/especiales");
    ...
    private void guardarLocalmente() {
        SharedPreferences pref = getSharedPreferences("Stock_CBZ", MODE_PRIVATE);
