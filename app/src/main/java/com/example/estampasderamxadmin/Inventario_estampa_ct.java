...
public class Inventario_estampa_ct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventario_estampa_captain);
        ...
        refE = FirebaseDatabase.getInstance().getReference("CaptianTsubasa/estampas");
        refEs = FirebaseDatabase.getInstance().getReference("CaptianTsubasa/especiales");
    ...
    private void guardarLocalmente() {
        SharedPreferences pref = getSharedPreferences("Stock_CaptainTsubasa", MODE_PRIVATE);
