...
public class Inventario_estampa_mb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventario_estampa_mb);
        ...
        refE = FirebaseDatabase.getInstance().getReference("MarioBros/estampas");
        refEs = FirebaseDatabase.getInstance().getReference("MarioBros/especiales");
        refT = FirebaseDatabase.getInstance().getReference("MarioBros/tarjetas");
    ...
    private void guardarLocalmente() {
        SharedPreferences pref = getSharedPreferences("Stock_MarioBros", MODE_PRIVATE);
    ...
    // Blindaje extra para el botón físico de atrás del dispositivo
    @Override
