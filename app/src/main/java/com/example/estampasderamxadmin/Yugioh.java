...
public class Yugioh extends AppCompatActivity {
    ...
    private static final String RUTA = "Yugioh/estampas";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yugioh);

        titulo = findViewById(R.id.titulo_yugi);
        spinnerFiltro = findViewById(R.id.spinner_filtro_db); // Inicializar Spinner
        titulo.setText("Yugioh");
        ...
        adapter = new AdapterEstampas(listaFiltrada, estampasDisponibles, 14, RUTA);
        ...
        btnSiguiente.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, Resumen_Yugioh.class);
            intent.putExtra("PUNTOS_YUGI", total);
    ...
    private void cargarDatos() {
        ...
        listener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // LLAMADA AUTOMÁTICA AL FILTRO: Carga la lista en cuanto Firebase responda
