...
public class Inventario_estampa_ho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inventario_estampa_hokage);
        ...
        refEstampas = FirebaseDatabase
                .getInstance()
                .getReference("Naruto_Hokage/estampas");
        ...
        // Guardar al finalizar (Quitamos el System.exit para evitar cierres violentos)
    ...
    private void guardarLocalmente() {
        SharedPreferences pref = getSharedPreferences("Stock_NarutoHokage", MODE_PRIVATE);
        ...
        if (datos != null) {
            ...
            // commit() síncrono: asegura la escritura física en el disco
            editor.commit();
        }
    }
    ...
    // Guardar si el usuario usa el botón físico de atrás del dispositivo
    @Override
